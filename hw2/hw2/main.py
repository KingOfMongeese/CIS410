...
def main() -> None:
    ...
    convert_to_f_btn = tk.Button(window, text='to F', command=lambda:btn_call_wrapper(c_to_f), width=50, height=10, background='#FF6103').pack()
    convert_to_c_btn = tk.Button(window, text='to C', command=lambda:btn_call_wrapper(f_to_c), width=50, height=10, background='#00FFFF').pack()
